...
```{r}
transition = read.table(url('https://raw.githubusercontent.com/MingChen0919/gst-colloquium-workshop-2018/master/content/S2-datasets/John_datasets/transitionmatrix.dat'))
```
